...
const globalAuth = globalThis as unknown as {
  folioOAuthClient: NodeOAuthClient | null;
};
globalAuth.folioOAuthClient ??= null;
...
export async function getOAuthClient(): Promise<NodeOAuthClient> {
  if (globalAuth.folioOAuthClient) return globalAuth.folioOAuthClient;

  globalAuth.folioOAuthClient = new NodeOAuthClient({
  ...
  return globalAuth.folioOAuthClient;
}
